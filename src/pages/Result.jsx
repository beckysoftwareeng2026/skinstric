  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-[#f4f4f2] text-black">
      ...
      <section className="relative flex min-h-[72vh] flex-col items-center justify-center overflow-hidden px-6 pb-28 pt-4 md:min-h-[72vh]">
        ...
        <div className="relative z-10 flex w-full max-w-3xl flex-col items-center gap-8 md:flex-row md:justify-center md:gap-20">
          <button
            onClick={() => navigate("/selfie")}
            className="flex w-full max-w-xs flex-col items-center gap-4 border border-transparent py-4 transition hover:border-black md:w-72"
          >
            <div className="relative flex h-28 w-28 items-center justify-center rounded-full border-2 border-black">
      ...
      <button
        ...
        className="absolute bottom-12 left-6 flex items-center gap-4 md:left-8"
      >
